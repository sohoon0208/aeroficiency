...
Technical references inform the model and testing methodology; their text, figures, data, and code are not redistributed. The README's [Engineering Scope](README.md#engineering-scope), [Limitations](README.md#limitations), and [Run Locally](README.md#run-locally) sections summarize the model boundaries and local verification workflow.
